...
{
    /// <summary>
    /// Clase que define las reglas de validación para la actualización de un prestador de servicio.
    /// </summary>
    public class PrestadorServicioUpdateValidator : AbstractValidator<PrestadorServicioUpdateRequest>
    {
        private readonly IUCABPagaloTodoDbContext _dbcontext; // nueva

        /// <summary>
        /// Constructor de la clase PrestadorServicioUpdateValidator.
        /// </summary>
        /// <param name="dbContext">Contexto de base de datos.</param>
        public PrestadorServicioUpdateValidator(IUCABPagaloTodoDbContext dbContext)
        {
            ...
            RuleFor(x => x.Rif)
                ...
                .Matches(new Regex(@"^[VEJPG][0-9]{9}$")).WithMessage("El RIF debe ser válido.");
        }
    }
}