...
{ 
    /// <summary>
   /// Validador para la creación de un administrador.
   /// </summary>
    public class AdministradorValidator : AbstractValidator<AdministradorRequest>
    {
        private readonly IUCABPagaloTodoDbContext _dbcontext;

        /// <summary>
        /// Crea una nueva instancia del validador de administrador.
        /// </summary>
        /// <param name="dbContext">Contexto de base de datos.</param>
        public AdministradorValidator(IUCABPagaloTodoDbContext dbContext)
            {
