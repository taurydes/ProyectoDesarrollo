...
{ 
    /// <summary>
    /// Clase que define las reglas de validación para la creación de un servicio prestado.
    /// </summary>
    public class ServicioPrestadoValidator : AbstractValidator<CrearServicioPrestadoRequest>
    {
        /// <summary>
        /// Constructor de la clase ServicioPrestadoValidator.
        /// </summary>
        public ServicioPrestadoValidator()
        {
            RuleFor(x => x.PrestadorServicioId)
                .NotEmpty().WithMessage("El ID del prestador de servicio no puede estar vacío.")
                .NotNull().WithMessage("El ID del prestador de servicio es obligatorio.");
