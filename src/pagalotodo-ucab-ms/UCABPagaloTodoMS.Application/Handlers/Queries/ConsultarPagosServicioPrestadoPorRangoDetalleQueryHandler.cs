...
public class ConsultarPagosServicioPrestadoPorRangoDetalleQueryHandler : IRequestHandler<ConsultarPagosServicioPrestadoPorRangoDetalleQuery, ServicioPrestadoPagosRangoResponse>
{
    private readonly IUCABPagaloTodoDbContext _dbContext;
    private readonly ILogger<ConsultarPagosServicioPrestadoPorRangoDetalleQueryHandler> _logger;

    /// <summary>
    /// Inicializa una nueva instancia de la clase <see cref="ConsultarPagosServicioPrestadoPorRangoDetalleQueryHandler"/>.
    /// </summary>
    /// <param name="dbContext">El contexto de la base de datos.</param>
    /// <param name="logger">El registrador.</param>
    public ConsultarPagosServicioPrestadoPorRangoDetalleQueryHandler(IUCABPagaloTodoDbContext dbContext, ILogger<ConsultarPagosServicioPrestadoPorRangoDetalleQueryHandler> logger)
    {
    ...
    public async Task<ServicioPrestadoPagosRangoResponse> Handle(ConsultarPagosServicioPrestadoPorRangoDetalleQuery request, CancellationToken cancellationToken)
    {
        try
        {
            if (request is null)
    ...
    /// <returns>Una tarea que representa la operación asíncrona con el ServicioPrestadoPagosRangoResponse.</returns>
    private async Task<ServicioPrestadoPagosRangoResponse> HandleAsync(ConsultarPagosServicioPrestadoPorRangoDetalleQuery request)
    {
        try
        {
