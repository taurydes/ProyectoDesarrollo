...
{  /// <summary>
   ...
   /// </summary>
    public class GuardarRespuestaEnArchivoDeTextoAprobadoCommand : IRequest<string>
    {
        public ServicioPrestadoPagosRangoResponse Response { get; }

        public GuardarRespuestaEnArchivoDeTextoAprobadoCommand(ServicioPrestadoPagosRangoResponse response)
        {
            Response = response;
        }
    }
